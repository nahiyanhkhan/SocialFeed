...
const posts = [
    {
        ...
        content: {
            text: 'What an amazing day! Just finished hiking Mount Fuji. The viewwas breathtaking! 🗻✨',
            media: [
                {
                    type: 'image',
    ...
    },
    {
        ...
        content: {
            ...
            media: [
                {
                    type: 'image',
                    src: 'https://images.unsplash.com/photo-1457976326363-73a4b5fb9e79?q=80&w=1470&fit=crop',
                },
            ],
        },
...
const PostList = ({ searchTerm }) => {
    ...
    if (filteredPosts.length === 0) {
        return <p className="text-center text-muted">No posts match your search.</p>;
    }
